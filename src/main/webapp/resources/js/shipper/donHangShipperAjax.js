...
//		console.log(donHangId);
		...
		$.get(href, function(donHang) {
			...
			$('#hoTenNguoiNhan').text("Rec: "+ donHang.hoTenNguoiNhan);
			...
			if(donHang.nguoiDat != null){
				$("#nguoiDat").text("Rec: "+ donHang.nguoiDat.hoTen);
			}
			...
			if(check){
				$('.chiTietTable').find('thead tr').append('<th id="soLuongNhanTag" class="border-0 text-uppercase small font-weight-bold"> Rec quantity </th>');
			}
			// thêm bảng:
			var sum = 0;
			var stt = 1;
