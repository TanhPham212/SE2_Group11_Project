$(document).ready(function() {
	...
	$('#danhMucDropdown').mouseup(function() {
		...
		if (open) {
            ...
            $(".modal-title").text("Add new category "+ label);
    ...
    $(document).on("click",".btnChiTiet", function() {
		...
		$.get(href, function(sanPham) {
			...
			$('.tenSanPham').html("<span style='font-weight: bold'>Name: </span> "+ sanPham.tenSanPham);
			$('.maSanPham').html("<span style='font-weight: bold'> Id: </span>"+ sanPham.id);
			$('.hangSangXuat').html("<span style='font-weight: bold'>Brand: </span>"+ sanPham.hangSanXuat.tenHangSanXuat);
			...
			if(checkTenDanhMuc != -1){
			  ...
			  $('.dungLuongPin').html("<span style='font-weight: bold'>Battery capacity: </span>"+ sanPham.dungLuongPin);
			  $('.heDieuHanh').html("<span style='font-weight: bold'>OS: </span>"+ sanPham.heDieuHanh);
			  $('.manHinh').html("<span style='font-weight: bold'>Monitor: </span>"+ sanPham.manHinh);
			}
			$('.thongTinChung').html("<span style='font-weight: bold'>Overall: </span>"+ sanPham.thongTinChung);
			$('.donGia').html("<span style='font-weight: bold'>Price: </span>"+ sanPham.donGia +" VNĐ");
			$('.baoHanh').html("<span style='font-weight: bold'>Warranty: </span>"+ sanPham.thongTinBaoHanh);
			$('.donViKho').html("<span style='font-weight: bold'>Stored unit: </span>"+ sanPham.donViKho);
			$('.donViBan').html("<span style='font-weight: bold'>Sell unit: </span>"+ sanPham.donViBan);
