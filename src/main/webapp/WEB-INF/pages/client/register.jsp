        ...
        <h2 class="form-signin-heading">Sign up</h2>
            ...
            <div class="form-group">
                <form:input type="number" path="soDienThoai" class="form-control"
                            placeholder="Phone" required="required"></form:input>
...
<head>
<meta charset="UTF-8">
<title>Hanu shop- Register</title>
...
<body>
	...
	<div class="login-page">
		<div class="form">
			<form:form method="POST" action='register' modelAttribute="newUser">
				<h2 class="form-signin-heading" style="text-align: center">Hanu shop- Register</h2>
				<hr/>
				<div class="form-group">
				...
				<p class="message" style="font-size: 18; padding-top:10px">Have an account? <a href="<c:url value='/login'/> ">Sign in</a></p>
			</form:form>
		</div>
	</div>
	<script
