...
<tr class="cart_line" id="item${sanpham.id}">
		...
		<td style="text-align: center; mergin-top: -52px;">
			...
			<p class="cart_masanpham">Product ID : <span>${sanpham.id}</span></p>
			<p class="">Warranty : ${sanpham.thongTinBaoHanh}</p>
		</td>
...
<tr>
		...
		&nbsp;  &nbsp;  &nbsp;  &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
		<a class="btn btn-warning " href="<%=request.getContextPath()%>/checkout"><span class="glyphicon glyphicon-check"></span> Checkout</a>
		</td>
		</c:if>
		...
		<td colspan="4">
			<p class="cart_tongdonhang">Total : <span id="ordertotal"></span> VND</p>
		</td>
</tr>
