		...
		<div class="header">
			...
			<div class="header-top-nav ">
				<c:if test="${pageContext.request.userPrincipal.name != null}">
					...
					<ul>
						<li>Hello: ${loggedInUser.hoTen}</li>
		...
		<div class="wrap">
			...
			<div class="top-nav">
				<ul>
					...
					<li><a href="<%=request.getContextPath()%>/shipping">Free Shipping</a></li>
					<li><a href="<%=request.getContextPath()%>/guarantee">Home Warranty</a></li>
