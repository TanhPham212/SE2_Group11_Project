...
<body>
	...
	<div class="col-md-9 animated bounce">
		<h3 class="page-header form-inline">Manage Order</h3>
		...
		<form class="form-inline" id="searchForm" name="searchObject">
			...
			<select class="form-control" id="trangThai">
				...
				<option value="Wait for approvalt">Wait for approval</option>
			...
			&nbsp;&nbsp; &nbsp;&nbsp;
			<button type="button" class="btn btn-primary" id="btnDuyetDonHang">Approve</button>
											...
											<div class="col-md-12">
												<table class="table chiTietTable"
													...
													<thead>
														<tr>
															<th
																class="border-0 text-uppercase small font-weight-bold">Num</th>
															<th
																class="border-0 text-uppercase small font-weight-bold">Product Name</th>

															<th
																class="border-0 text-uppercase small font-weight-bold">Price</th>
															<th
																class="border-0 text-uppercase small font-weight-bold">Quantity</th>
			...
			<div>
				<div class="modal fade" id="phanCongModal" tabindex="-1"
					...
					<div class="modal-dialog" role="document">
						<div class="modal-content">
							<div class="modal-header">
								<h5 class="modal-title" id="exampleModalLabel">Order Distribute</h5>
								<button type="button" class="close" data-dismiss="modal"
									aria-label="Close">
									<span aria-hidden="true">&times;</span>
								</button>
							...
							<div class="modal-body">
								...
								<div class="form-group">
									Choose a shipper: <select class="form-control"
										name="shipper">
								...
								<div class="form-group">
									<div class="col-md-12">
										<table class="table chiTietTable"
											...
											<thead>
												<tr>
													<th class="border-0 text-uppercase small font-weight-bold">number</th>
													...
													<th class="border-0 text-uppercase small font-weight-bold">Received quantity</th>
												</tr>
											</thead>
											<tbody>
											</tbody>
										</table>
										<h4 id="tongTienXacNhan" style="float: right; font-weight: bold;padding-right: 50px">total</h4>
									</div>
