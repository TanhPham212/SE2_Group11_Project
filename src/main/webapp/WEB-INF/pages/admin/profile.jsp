...
<body>
	...
	<div class="col-md-9 animated bounce">
		<h3 class="page-header">Personal Infomation</h3>

		<button class="btn btn-success btnCapNhatThongTin">Update Info</button>
		&nbsp;&nbsp;&nbsp;
					...
					<div class="modal-dialog" role="document">
						<div class="modal-content">
							...
							<div class="modal-body">
								...
								<div class="form-group">
									<label for="name">confirm your new password</label> <input
