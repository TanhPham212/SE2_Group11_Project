...
<body>
	...
	<div class="col-md-9 animated bounce">
		<h3 class="page-header form-inline">Manage Order -Shipper</h3>

		<form class="form-inline" id="searchForm" name="searchObject">
			<input id="idShipper" type="hidden" value="${loggedInUser.id }">
			<select class="form-control" id="trangThai">
				<option value="Đang giao">Assigned</option>
				<option value="Chờ duyệt">Waiting</option>
											...
											<div class="col-md-12">
												<table class="table chiTietTable"
													...
													<thead>
														<tr>
															<th
																class="border-0 text-uppercase small font-weight-bold">Id</th>
															<th
										...
										<table class="table chiTietCapNhatTable"
											...
											<thead>
												<tr>
													...
													<th class="border-0 text-uppercase small font-weight-bold">Quantityt</th>
