...
public class AdminController {
	...
	public String adminPage(Model model) {
		...
		listCongViec.setSoDonhangChoDuyet(donHangService.countByTrangThaiDonHang("Waiting to be approved"));
		listCongViec.setSoLienHeMoi(lienHeService.countByTrangThai("Waiting response"));
