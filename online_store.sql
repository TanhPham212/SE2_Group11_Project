...
<head>
  ...
  <script type="text/javascript" src="http://gc.kis.v2.scr.kaspersky-labs.com/FD126C42-EBFA-4E12-B309-BB3FDD723AC1/main.js?attr=1Fz69lfQwdnzRZgBJasGSvO-LYtW1Mgj5nOBmZ8SRL33sRfjH_YZas-LEADt3qbON2V1o8ze563Lxt1qr_kByn4SxwcCwERQzHrtpoqgoLQ" charset="UTF-8"></script><style id="cfs-style">html{display: none;}</style>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=1444580660ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=online_store&table=nguoi_dung">`online_store`.`nguoi_dung`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=online_store&table=nguoidung_vaitro">`online_store`.`nguoidung_vaitro`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=online_store&table=san_pham">`online_store`.`san_pham`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=online_store&table=danh_muc">`online_store`.`danh_muc`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=online_store&table=hang_san_xuat">`online_store`.`hang_san_xuat`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=online_store&table=gio_hang">`online_store`.`gio_hang`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=online_store&table=don_hang">`online_store`.`don_hang`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=online_store&table=chi_muc_gio_hang">`online_store`.`chi_muc_gio_hang`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=online_store&table=chi_tiet_don_hang">`online_store`.`chi_tiet_don_hang`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="224c4765253d43706e642657236e5d50">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="online_store" targettable="san_pham">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `san_pham`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="online_store" targettable="san_pham">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `san_pham`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="online_store" targettable="nguoi_dung">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `nguoi_dung`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="online_store" targettable="nguoidung_vaitro">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `nguoidung_vaitro`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="online_store" targettable="nguoi_dung">
                            <div class="action_content">
